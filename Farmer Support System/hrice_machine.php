...
<head>
    ...
    <link rel="stylesheet" href="hall_stylesheet.css"> <!-- Provide correct path to your stylesheet -->
</head>
<body>
<header>
...
if ($conn->connect_error) {
    ...
    $sql = "SELECT * FROM information WHERE equipment_name='rice_machine'";
...
document.addEventListener('DOMContentLoaded', function () {
    ...
    searchBtn.addEventListener('click', function () {
        ...
        xhr.open("GET", "hfetch_data2.php?state=" + selectedState + "&district=" + selectedDistrict + "&taluka=" + selectedTaluka ,true);
