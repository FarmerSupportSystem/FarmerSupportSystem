...
if ($conn->connect_error) {
    ...
    $sql = "SELECT * FROM information WHERE equipment_name='thresher'";
...
document.addEventListener('DOMContentLoaded', function () {
    ...
    searchBtn.addEventListener('click', function () {
        ...
        xhr.open("GET", "hfetch_data.php?state=" + selectedState + "&district=" + selectedDistrict + "&taluka=" + selectedTaluka ,true);
