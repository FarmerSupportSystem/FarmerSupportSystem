...
<html lang="en">
  ...
  <script src="https://cdn.jsdelivr.net/npm/bootstrap@5.3.2/dist/js/bootstrap.bundle.min.js" integrity="sha384-C6RzsynM9kWDrMNeT87bh95OGNyZPhcTNXj1NW7RuBCsyN/o0jlpcV8Qyq46cDfL" crossorigin="anonymous"></script>
    ...
    <title>farmer support | Farmer</title>
  </head>
  <body>
  ...
  <nav class="navbar navbar-expand-lg bg-success">
    <div class="container-fluid">
      <h2 class="navbar-brand mb-0" href="#"> <img src="farmer.png" width=40 height=40 alt=""></h2>
      ...
      <div class="collapse navbar-collapse" id="navbarSupportedContent">
        <ul class="navbar-nav me-auto mb-2 mb-lg-0">
          ...
          <li class="nav-item">
            <a class="nav-link" href="dindex.php">Profile</a>
          </li>
  ...
  <!-- HEDER END -->
      ...
      <div class="section__container header__container" id="home">
        <p>Welcomes</p>
        <h1>All Indians Farmer</h1>
        <div class="header__flex">
          <div class="header__card">
            <span><i class="ri-truck-fill"></i></span>
            <div>
              <h4>
            <a style="color: #E4D5C7;;" href="hHome.php">Agriculture Equipment Rent</a>
              </h4>
            </div>
          </div>
          <div class="header__card">
            <span><i class="ri-plant-fill"></i></span>
            <div>
              
              <h4><a style="color: #E4D5C7;;" href="aHome.php">Farm Leasning</a></h4>
    ...
    <footer>
      ...
      <div>
        <p>&copy;23~2024 Farmer Support</p>
      </div>
    </footer>
