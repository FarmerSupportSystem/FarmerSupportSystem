...
<body>
    ...
    <div class="container-fluid">
      ...
      <div class="collapse navbar-collapse" id="navbarSupportedContent">
        <ul class="navbar-nav me-auto mb-2 mb-lg-0">
          ...
          <li class="nav-item">
            <a class="nav-link" href="Hprofile.php"><b>Profile</b></a>
          </li>
          <li class="nav-item">
  ...
  <div class="container mt-4 land-details-container">
    ...
    ?>
          ...
          <div class="prodata">
            <p class="mt-4"><img src="<?php echo $row["image_f"] ?>"width="40" height="40"> <strong><?php echo $row["equipment_name"] ?>: </strong>
              <strong> <?php echo $row["model_name"] ?></strong>
              <strong>; &#8377;<?php echo $row["rent_rate"] ?></strong>


              <a href="Hdelete.php?id=<?php echo $row["sr_no"] ?>" onclick=" return confirm('Are you sure , you want to delet?')" style="float: right"  class="btn  btn-sm btn-danger" >Delete</a>
            </p>
          </div>
    ...
    $pdo = null;
    ?>
    <a href="hadd.php" class="btn mt-5 m-3 btn-success"><b>+</b> Add</a>
  </div>
